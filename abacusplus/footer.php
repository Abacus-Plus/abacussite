...
<section class="footer">
    ...
    <div class="container">
        ...
        <div class="footer__copyright">
            ...
            <button class="footer__button secondary-button medium icon-right" id="backToTop">Back to top</button>
        </div>

        <div class="footer__mobile">
            <div class="footer__copyright-2">
                <a href="<?php echo $footer['custom_link']['link'] ?>" class="privacy w-500 color-is-black"><?php echo $footer['custom_link']['text'] ?></a>
                <button class="footer__button secondary-button medium icon-right" id="backToTopmobile">Back to top</button>
            </div>
            <p class="w-400 color-is-black"><?php echo $footer['copyright']; ?></p>
